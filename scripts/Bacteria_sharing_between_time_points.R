...
colnames(spacers_analysis)=gsub("sample","Old_Sample_ID",colnames(spacers_analysis))
spacers_analysis=merge(spacers_analysis,metadata,by=c("Old_Sample_ID"))
...
spacer_output$Old_Subject_ID<-NULL
...
spp_prevalence=aggregate(count ~ Old_Sample_ID+bacteria, spacers_analysis, sum)
...
spacer_output$timepoints=gsub(".*\\.","",spacer_output$Old_Sample_ID)
###output the spacers
p=list()
plot.new()
d=list()
...
p[[3]]=ggplot(d[[3]],aes(x=V1,y=Old_Sample_ID))+geom_tile()+facet_grid(V3 ~ ., space="free",scale="free")+ theme_bw()+theme(panel.spacing = unit(0.1, "lines"),axis.title.y=element_blank(),panel.grid.major = element_blank(), panel.grid.minor = element_blank(), strip.background = element_rect(fill = NA, color = NA), panel.border = element_rect(colour = "black", fill = NA),axis.text.x = element_blank(),strip.text.y = element_text(angle = 0))+
...
p[[4]]=ggplot(d[[4]],aes(x=V1,y=Old_Sample_ID))+geom_tile()+facet_grid(V3 ~ ., space="free",scale="free")+ theme_bw()+theme(panel.spacing = unit(0.1, "lines"),axis.title.y=element_blank(),panel.grid.major = element_blank(), panel.grid.minor = element_blank(), strip.background = element_rect(fill = NA, color = NA), panel.border = element_rect(colour = "black", fill = NA),axis.text.x = element_blank(),strip.text.y = element_text(angle = 0))+
...
p[[5]]=ggplot(d[[5]],aes(x=V1,y=Old_Sample_ID))+geom_tile()+facet_grid(V3 ~ ., space="free",scale="free")+ theme_bw()+theme(panel.spacing = unit(0.1, "lines"),axis.title.y=element_blank(),panel.grid.major = element_blank(), panel.grid.minor = element_blank(), strip.background = element_rect(fill = NA, color = NA), panel.border = element_rect(colour = "black", fill = NA),axis.text.x = element_blank(),strip.text.y = element_text(angle = 0))+
...
p[[6]]=ggplot(d[[6]],aes(x=V1,y=Old_Sample_ID))+geom_tile()+facet_grid(V3 ~ ., space="free",scale="free")+ theme_bw()+theme(panel.spacing = unit(0.1, "lines"),axis.title.y=element_blank(),panel.grid.major = element_blank(), panel.grid.minor = element_blank(), strip.background = element_rect(fill = NA, color = NA), panel.border = element_rect(colour = "black", fill = NA),axis.text.x = element_blank(),strip.text.y = element_text(angle = 0))+
...
p[[7]]=ggplot(d[[7]],aes(x=V1,y=Old_Sample_ID))+geom_tile()+facet_grid(V3 ~ ., space="free",scale="free")+ theme_bw()+theme(panel.spacing = unit(0.1, "lines"),axis.title.y=element_blank(),panel.grid.major = element_blank(), panel.grid.minor = element_blank(), strip.background = element_rect(fill = NA, color = NA), panel.border = element_rect(colour = "black", fill = NA),axis.text.x = element_blank(),strip.text.y = element_text(angle = 0))+
...
p[[8]]=ggplot(d[[8]],aes(x=V1,y=Old_Sample_ID))+geom_tile()+facet_grid(V3 ~ ., space="free",scale="free")+ theme_bw()+theme(panel.spacing = unit(0.1, "lines"),axis.title.y=element_blank(),panel.grid.major = element_blank(), panel.grid.minor = element_blank(), strip.background = element_rect(fill = NA, color = NA), panel.border = element_rect(colour = "black", fill = NA),axis.text.x = element_blank(),strip.text.y = element_text(angle = 0))+
...
p[[9]]=ggplot(d[[9]],aes(x=V1,y=Old_Sample_ID))+geom_tile()+facet_grid(V3 ~ ., space="free",scale="free")+ theme_bw()+theme(panel.spacing = unit(0.1, "lines"),axis.title.y=element_blank(),panel.grid.major = element_blank(), panel.grid.minor = element_blank(), strip.background = element_rect(fill = NA, color = NA), panel.border = element_rect(colour = "black", fill = NA),axis.text.x = element_blank(),strip.text.y = element_text(angle = 0))+
...
p[[10]]=ggplot(d[[10]],aes(x=V1,y=Old_Sample_ID))+geom_tile()+facet_grid(V3 ~ ., space="free",scale="free")+ theme_bw()+theme(panel.spacing = unit(0.1, "lines"),axis.title.y=element_blank(),panel.grid.major = element_blank(), panel.grid.minor = element_blank(), strip.background = element_rect(fill = NA, color = NA), panel.border = element_rect(colour = "black", fill = NA),axis.text.x = element_blank(),strip.text.y = element_text(angle = 0))+
...
p[[11]]=ggplot(d[[11]],aes(x=V1,y=Old_Sample_ID))+geom_tile()+facet_grid(V3 ~ ., space="free",scale="free")+ theme_bw()+theme(panel.spacing = unit(0.1, "lines"),axis.title.y=element_blank(),panel.grid.major = element_blank(), panel.grid.minor = element_blank(), strip.background = element_rect(fill = NA, color = NA), panel.border = element_rect(colour = "black", fill = NA),axis.text.x = element_blank(),strip.text.y = element_text(angle = 0))+
...
p[[12]]=ggplot(d[[12]],aes(x=V1,y=Old_Sample_ID))+geom_tile()+facet_grid(V3 ~ ., space="free",scale="free")+ theme_bw()+theme(panel.spacing = unit(0.1, "lines"),axis.title.y=element_blank(),panel.grid.major = element_blank(), panel.grid.minor = element_blank(), strip.background = element_rect(fill = NA, color = NA), panel.border = element_rect(colour = "black", fill = NA),axis.text.x = element_blank(),strip.text.y = element_text(angle = 0))+
...
p[[13]]=ggplot(d[[13]],aes(x=V1,y=Old_Sample_ID))+geom_tile()+facet_grid(V3 ~ ., space="free",scale="free")+ theme_bw()+theme(panel.spacing = unit(0.1, "lines"),axis.title.y=element_blank(),panel.grid.major = element_blank(), panel.grid.minor = element_blank(), strip.background = element_rect(fill = NA, color = NA), panel.border = element_rect(colour = "black", fill = NA),axis.text.x = element_blank(),strip.text.y = element_text(angle = 0))+
...
p[[14]]=ggplot(d[[14]],aes(x=V1,y=Old_Sample_ID))+geom_tile()+facet_grid(V3 ~ ., space="free",scale="free")+ theme_bw()+theme(panel.spacing = unit(0.1, "lines"),axis.title.y=element_blank(),panel.grid.major = element_blank(), panel.grid.minor = element_blank(), strip.background = element_rect(fill = NA, color = NA), panel.border = element_rect(colour = "black", fill = NA),axis.text.x = element_blank(),strip.text.y = element_text(angle = 0))+
